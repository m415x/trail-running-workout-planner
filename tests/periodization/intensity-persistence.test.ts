...
function createTestDatabase() {
  ...
  sqliteDatabase.exec(`
    ...
    CREATE TABLE group_training_plans (id TEXT PRIMARY KEY, group_id TEXT NOT NULL, planning_cohort_id TEXT, source_group_training_plan_id TEXT, title TEXT NOT NULL, status TEXT DEFAULT 'draft', notes TEXT, is_deleted INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT);
    ...
    CREATE TABLE session_generation_preferences (id TEXT PRIMARY KEY, group_training_plan_id TEXT NOT NULL UNIQUE, frequency_mode TEXT NOT NULL, fixed_sessions_per_week INTEGER, weekly_pattern TEXT NOT NULL, is_deleted INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT);
    CREATE TABLE macrocycles (id TEXT PRIMARY KEY, group_training_plan_id TEXT NOT NULL, title TEXT NOT NULL, start_date TEXT NOT NULL, end_date TEXT NOT NULL, tapering_weeks_count INTEGER, target_race_name TEXT, target_race_date TEXT, target_race_distance_km REAL, target_race_elevation_gain INTEGER, notes TEXT, is_deleted INTEGER DEFAULT 0, created_at TEXT, updated_at TEXT);
...
function seedPlan(testDatabase: TestDatabase) {
  ...
  testDatabase.insert(sessionGenerationPreferences).values({
    id: 'generation-1',
    groupTrainingPlanId: 'plan-1',
    frequencyMode: 'fixed',
  ...
  testDatabase.insert(microcycles).values({
    ...
    startDate: '2026-01-05', endDate: '2026-01-11', targetVolumeKm: 20,
  }).run()
}
