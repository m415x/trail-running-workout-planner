...
INSERT INTO `__new_field_performance_tests`("id", "is_deleted", "created_at", "updated_at", "athlete_id", "performed_at", "protocol", "source", "test_event_id", "execution_context", "recorded_by", "recorded_by_user_id", "review_status", "distance_m", "elapsed_time_sec", "notes") SELECT "id", "is_deleted", "created_at", "updated_at", "athlete_id", "performed_at", "protocol", "source", "test_event_id", "execution_context", "recorded_by", "recorded_by_user_id", "review_status", "distance_m", "elapsed_time_sec", "notes" FROM `field_performance_tests`;--> statement-breakpoint
