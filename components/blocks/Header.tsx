  ...
  return (
    <div className='px-5 pt-14 pb-3 flex items-center justify-between'>
      <div>
        ...
        <h1 className='font-heading text-foreground text-[28px] font-bold mt-0.5 leading-tight'>Hola, Cristian</h1>
      </div>
      <AnimatedThemeToggler variant='star' className='text-muted-foreground' />
