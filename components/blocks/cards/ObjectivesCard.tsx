...
export function ObjectivesCard() {
  return (
    <CustomCard className='flex-row items-center justify-between bg-linear-to-r from-primary/20 to-primary/10 border-none'>
      <div>
        <p className='text-muted-foreground text-[11px] mb-1'>Objetivo del macrociclo</p>
        <p className='font-barlow text-foreground font-bold text-[20px] leading-tight'>Carrera 10 km</p>
      ...
      <div className='text-right'>
        ...
        <p className='font-barlow font-black text-primary text-[38px] leading-none'>170</p>
