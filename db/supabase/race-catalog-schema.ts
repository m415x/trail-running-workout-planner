...
import { baseColumns, trainingGoals } from '@/db/supabase/schema'
import type {
...
export const raceEditions = pgTable(
  'race_editions',
  {
    ...baseColumns,
    ...
    location: jsonb('location').$type<RaceEditionLocation | null>(),
    websiteUrl: text('website_url'),
    notes: text('notes'),
...
export const raceCourses = pgTable(
  'race_courses',
  {
    ...baseColumns,
    ...
    modality: jsonb('modality').$type<RaceCourseModality | null>(),
    classifications: jsonb('classifications').$type<RaceCourseClassification[]>().notNull(),
...
export const competitionEntryRaceCourses = pgTable(
...
export const trainingGoalRaceCourses = pgTable(
