...
export const teamEconomicPolicies = sqliteTable(
...
export const athleteBillingTerms = sqliteTable(
...
export const monthlyCharges = sqliteTable(
  'monthly_charges',
  {
    ...baseColumns,
    athleteId: text('athlete_id').notNull().references(() => athleteProfiles.id, { onDelete: 'restrict' }),
    billingTermsId: text('billing_terms_id').notNull().references(() => athleteBillingTerms.id, { onDelete: 'restrict' }),
