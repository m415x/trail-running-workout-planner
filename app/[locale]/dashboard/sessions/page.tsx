    ...
    <div className='space-y-6'>
      <div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Entrenamientos programados para el equipo.</p>
        </div>
      ...
      {sessions.length === 0 ? (
        <Card>
          <CardHeader>
            <CardTitle>Todavía no hay sesiones</CardTitle>
            <CardDescription>Programá la primera sesión para comenzar a construir el calendario de entrenamiento.</CardDescription>
          </CardHeader>
        </Card>
      ) : (
