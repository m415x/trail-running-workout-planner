      ...
      <div className='relative mx-auto flex w-full max-w-3xl flex-col p-6 py-10'>
        <div className='mb-4 flex items-center gap-8 max-[24rem]:gap-4'>
          ...
          <div className='flex flex-col gap-0.5 sm:gap-1'>
            <span className='font-medium text-lg tracking-tight sm:text-2xl'>John Doe</span>
            <span className='text-muted-foreground sm:text-lg'>john.doe@example.com</span>
          </div>
        </div>

        <p className='mt-0.5 line-clamp-4 text-muted-foreground'>
          I&apos;m a passionate software developer with over 5 years of experience building web applications. I love
          working with modern technologies and creating user-friendly interfaces that solve real-world problems.
        </p>
